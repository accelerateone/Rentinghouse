...
<head>
    ...
    <title>${siteName!""}|租房特色管理-${title!""}</title>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as rentHouseFeatures>
                                            <tr>
                                                <td style="vertical-align:middle;">
                                                    <label class="lyear-checkbox checkbox-primary">
                                                        <input type="checkbox" name="ids[]"
                                                               value="${rentHouseFeatures.id}"><span></span>
                                                    </label>
                                                </td>

                                                <td style="vertical-align:middle;">${rentHouseFeatures.name}</td>
                                                <td style="vertical-align:middle;" style="vertical-align:middle;"><font
                                                        class="text-success">${rentHouseFeatures.createTime}</font>
                                                </td>
                                            </tr>
                                            </#list>
                                        <#else>
    ...
    function deleteReq(id, url) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('租房特色删除成功!', function () {
