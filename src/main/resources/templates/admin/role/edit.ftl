                            ...
                            <div class="card-body">
                                <form action="add" id="role-add-form" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <select name="roleType" class="form-control" id="roleType">
                                        <#list roleTypes as roleType>
                                            <option value="${roleType}" <#if role.roleType.getCode() == roleType.getCode()>selected</#if> >${roleType.getName()}</option>
                                        </#list>
                                        </select>
                                    </div>
                                                    ...
                                                    <td>
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input name="authorities" type="checkbox"
                                                                   ...
                                                                   dataid="id-${topMenu.id}" value="${topMenu.id}">
