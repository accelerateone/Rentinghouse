    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-danger">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">前台用户总数</p>
        ...
        <div class="col-lg-6">
          <div class="">
            <div class="card-body">
              <canvas id="chart-pie" style="float: right" width="280" height="280"></canvas>
            </div>
          </div>
        </div>
                ...
                <div class="card bg-primary">
                    <div class="card-body clearfix">
                        <div class="pull-left">
                            ...
                            <p class="h3 text-white m-b-0">${showTipsUrlText}<a href="${showTipsUtl}" style="color:red;margin-right:20px;">https://www.hit.com</a><a href="javascript:void(0)" class="btn btn-danger" id="order-auth-btn">${showTipsBtnText}</a></p>
...
new Chart($("#chart-pie"), {
  ...
  data: {
    labels: ["经纪人", "顾问",],
    datasets: [{
      data: [${agentCount!0}, ${consultantCount!0}],
...
new Chart($("#chart-doughnut"), {
  ...
  data: {
    labels: ["新房", "二手房", "租房"],
    datasets: [{
      data: [${newHouseInfoTotal!0}, ${houseInfoTotal!0}, ${rentHouseTotal!0}],
