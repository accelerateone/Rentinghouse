...
<title>${siteName!""}|房屋照片管理-添加房屋照片</title>
    ...
    <main class="lyear-layout-content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加房屋照片</h4></div>
              <div class="card-body">
                <form action="add" id="user-add-form" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="" placeholder="请输入照片名" tips="请填写照片名" />
                  </div>
