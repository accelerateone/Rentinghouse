...
<title>${siteName!""}|楼盘特色管理-${title!""}</title>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageBean.content as housingCharacteristics>
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${housingCharacteristics.id}"><span></span>
                          </label>
                        </td>

                        <td style="vertical-align:middle;">${housingCharacteristics.name}</td>
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${housingCharacteristics.createTime}</font></td>
                      </tr>
                    </#list>
                    <#else>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('楼盘特色删除成功!',function(){
