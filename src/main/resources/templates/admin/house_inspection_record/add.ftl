...
<title>${siteName!""}|带看记录管理-添加带看记录</title>
    ...
    <main class="lyear-layout-content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加带看记录</h4></div>
              <div class="card-body">
                <form action="add" id="add-form" class="row">
                    ...
                    <div class="input-group m-b-10">
                        ...
                        <select name="houseInfo" class="form-control houseInfo" id="houseInfo"></select>
                    </div>
