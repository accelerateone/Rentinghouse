...
<head>
    ...
    <title>${siteName!""}|顾问管理-编辑顾问</title>
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>编辑顾问</h4></div>
                            <div class="card-body">
                                <form action="add" id="user-add-form" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="username" name="username"
                                               value="${user.username}" placeholder="请输入顾问名(即为登录名称)" tips="请填写顾问名"/>
                                    </div>
                                    <div class="input-group m-b-10">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="tel" class="form-control required" id="mobile" name="mobile"
                                               value="${user.mobile}" placeholder="请输入手机号码" tips="请填写手机号码"/>
                                    </div>
                                    <div class="input-group"
                                         style="margin-top:15px;margin-bottom:15px;padding-left:25px;">状态：
        ...
        $("#add-form-submit-btn").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == 0) {
                        showSuccessMsg('顾问编辑成功!', function () {
