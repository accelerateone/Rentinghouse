...
<head>
    ...
    <title>${siteName!""}|经纪人管理-添加经纪人</title>
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h4>添加经纪人</h4></div>
                            <div class="card-body">
                                <form action="add" id="user-add-form" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="username" name="username"
                                               value="" placeholder="请输入经纪人名(即为登录名称)" tips="请填写经纪人名"/>
                                    </div>
                                    <div class="input-group m-b-10">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <select name="role.id" class="form-control required" id="role">
                                        <#list roles as role>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="tel" class="form-control required" id="mobile" name="mobile"
                                               value="" placeholder="请输入手机号码" tips="请输入手机号码"/>
                                    </div>

                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">证件编码</span>
                                        <input type="text" class="form-control required" id="certificate" name="certificate"
                                               value="" placeholder="请输入证件编码" tips="请输入证件编码"/>
                                    </div>



                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">服务年限</span>
                                        <input type="number" class="form-control required" id="yearsOfService" name="yearsOfService"
                                               placeholder="请输入服务年限(数字)" tips="请输入服务年限" value=""/>
                                    </div>


                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">个人标签</span>
                                        <input type="tel" class="form-control" id="label" name="label"
                                               placeholder="请输入个人标签（比如法律顾问，金牌经纪人;选填）" value=""/>
                                    </div>
        ...
        $("#add-form-submit-btn").click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.code == 0) {
                        showSuccessMsg('经纪人添加成功!', function () {
