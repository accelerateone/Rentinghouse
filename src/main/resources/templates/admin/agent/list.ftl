...
<head>
    ...
    <title>${siteName!""}|经纪人管理-${title!""}</title>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <button class="btn btn-default dropdown-toggle" id="search-btn"
                                                    ...
                                                    aria-expanded="false">
                                                经纪人名 <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)"
                                                       data-field="title">经纪人名</a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align:middle;">
                                                    <#if user.headPic??>
                                                        <#if user.headPic?length gt 0>
                                                            <img src="/photo/view?filename=${user.headPic}" width="60px"
                                                                 height="60px">
                                                        <#else>
                                                ...
                                                <td style="vertical-align:middle;">${user.certificate}</td>
                                                <td style="vertical-align:middle;">${user.yearsOfService}</td>
                                                ...
                                                <td style="vertical-align:middle;" style="vertical-align:middle;"><font
                                                        class="text-success">${user.createTime}</font></td>
                                            </tr>
                                            </#list>
                                        <#else>
                                        <tr align="center">
    ...
    function deleteReq(id, url) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('经纪人删除成功!', function () {
