...
public class SystemController {
	...
	public String index(Model model){
		...
		model.addAttribute("userTotal", homeUserService.total());
		model.addAttribute("agentCount",userService.countByAgent());
		model.addAttribute("consultantCount",userService.countByConsultant());
		model.addAttribute("operatorLogTotal", operaterLogService.total());
		model.addAttribute("newHouseInfoTotal", newHouseInfoService.count());
		model.addAttribute("databaseBackupTotal", databaseBakService.total());
		model.addAttribute("rentHouseTotal",rentHouseService.total());
		model.addAttribute("houseInfoTotal",houseInfoService.count());
